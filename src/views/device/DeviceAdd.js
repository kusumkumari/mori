  ...
  render() {
    ...
    return (
      <Card>
        <CardBody>
          <CardTitle>
            <IntlMessages id="add.device-management" /> <i className="iconsminds-add text-primary" style={{fontSize:"large"}}  />
          </CardTitle>
          ...
          <Form className="dashboard-quick-post">
            ...
            <Button className="float-right" color="primary" onClick={addDeviceHandler} >
