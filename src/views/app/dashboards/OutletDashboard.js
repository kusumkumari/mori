...
import { listOutletDashboardAPI, OutletOnOffAPI, getOutletOnOffAPI} from '../../ApiIntegration';
...
class OutletDashboard extends Component {
  ...
  listOutletDashboardAPI((apiResponse) => {
    if (apiResponse.status == "success") {
      this.setState({
        orderCardData: apiResponse.response.data.data ? apiResponse.response.data.data[0] : "",
        bestSeller: apiResponse.response.data.data ? apiResponse.response.data.data[0].best_seller : "",
        bestSellerLength: apiResponse.response.data.data ? apiResponse.response.data.data[0].best_seller.length : null,
        revenuData: apiResponse.response.data.data ? apiResponse.response.data.data[0].outlet_revenue : "",
        orderDetails: apiResponse.response.data.data ? apiResponse.response.data.data[0].order_details : "",
        week1Report: apiResponse.response.data.data ? apiResponse.response.data.data[0].week_1_report : "",
        week2Report: apiResponse.response.data.data ? apiResponse.response.data.data[0].week_2_report : "",
        newCustomerReport: apiResponse.response.data.data ? apiResponse.response.data.data[0].new_customer_report : "",
        loyalCustomerReport: apiResponse.response.data.data ? apiResponse.response.data.data[0].loyal_customer_report : "",
      });
    }
  });
}
getOutletOnOff(){
  getOutletOnOffAPI((apiResponse) => {
    if (apiResponse.status == "success") {
      this.setState({
        is_open:apiResponse.response.data ? apiResponse.response.data.is_open : "",
      });
    }
  });
}
